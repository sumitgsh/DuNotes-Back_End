...
public class Constants {
	...
	public static final String SUCCESS_MSG = "Successfully Uploaded ";
	...
	public static final String TEMP_DIR = "D:\\EasyAccess.com\\website\\src\\main\\resources\\temp\\";
	public static final String INVALID_FILE_DIMENSIONS = "Invalid file dimensions. File size should not be more than 25MB";
	public static final String INVALID_FILE_FORMAT = "Only PNG, JPEG and JPG,PDF files are allowed";
